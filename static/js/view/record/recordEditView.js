...
module.exports = Backbone.View.extend({
  ...
  events: {
    'click #recordEditCamera' : 'showModal',
    'click #recordEditSnap': 'snapShot',
    'click #recordEditRepeat': 'repeat',
    'click #recordBtnPic': 'showPic',
  ...
  render: function () {
    $.get(rootView + this.template, function (template) {
      ...
      this.$snap = this.$el.find('#recordEditSnap');
